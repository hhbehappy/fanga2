<x-app>
  ...
  <div class="w-screen md:w-full">
    <div class="flex overflow-x-scroll mx-6 pb-8">
      <div class="flex flex-none flex-nowrap">
        ...
        <div class="w-36 mr-5">
          <img src="<?php echo 'https://pic.duga.jp/unsecure/' . $re_productid . '/noauth/jacket.jpg' ?>"
            alt="<?php echo '【DUGA】' . $videoid->title . 'のジャケット画像' ?>" class="h-[6rem] -mb-1">
        </div>
        @endif
        @if ($videoid->thumbnail01)
        <div class="mr-5">
          <img src="<?php echo $videoid->thumbnail01 ?>" alt="<?php echo '【DUGA】' . $videoid->title . 'の1枚目の画像' ?>"
            class="h-[5rem]">
        </div>
        @endif
        @if ($videoid->thumbnail02)
        <div class="mr-5">
          <img src="<?php echo $videoid->thumbnail02 ?>" :alt="'【DUGA】' . $videoid->title . 'の2枚目の画像'" class="h-[5rem]">
        </div>
        @endif
        @if ($videoid->thumbnail03)
        <div class="mr-5">
          <img src="<?php echo $videoid->thumbnail03 ?>" :alt="'【DUGA】' . $videoid->title . 'の3枚目の画像'" class="h-[5rem]">
        </div>
        @endif
        @if ($videoid->thumbnail04)
        <div class="mr-5">
          <img src="<?php echo $videoid->thumbnail04 ?>" :alt="'【DUGA】' . $videoid->title . 'の4枚目の画像'" class="h-[5rem]">
        </div>
        @endif
        @if ($videoid->thumbnail05)
        <div class="mr-5">
          <img src="<?php echo $videoid->thumbnail05 ?>" :alt="'【DUGA】' . $videoid->title . 'の5枚目の画像'" class="h-[5rem]">
        </div>
        @endif
        @if ($videoid->thumbnail06)
        <div class="mr-5">
          <img src="<?php echo $videoid->thumbnail06 ?>" :alt="'【DUGA】' . $videoid->title . 'の6枚目の画像'" class="h-[5rem]">
        </div>
        @endif
        @if ($videoid->thumbnail07)
        <div class="mr-5">
          <img src="<?php echo $videoid->thumbnail07 ?>" :alt="'【DUGA】' . $videoid->title . 'の7枚目の画像'" class="h-[5rem]">
        </div>
        @endif
        @if ($videoid->thumbnail08)
        <div class="mr-5">
          <img src="<?php echo $videoid->thumbnail08 ?>" :alt="'【DUGA】' . $videoid->title . 'の8枚目の画像'" class="h-[5rem]">
        </div>
        @endif
        @if ($videoid->thumbnail09)
        <div class="mr-5">
          <img src="<?php echo $videoid->thumbnail09 ?>" :alt="'【DUGA】' . $videoid->title . 'の9枚目の画像'" class="h-[5rem]">
        </div>
        @endif
        @if ($videoid->thumbnail10)
        <div class="mr-5">
          <img src="<?php echo $videoid->thumbnail10 ?>" :alt="'【DUGA】' . $videoid->title . 'の10枚目の画像'"
            class="h-[5rem]">
        </div>
        @endif
        <div class="flex w-32 mt-4 justify-center text-blue-500 hover:underline hover:text-red-500">
          <a href="<?php echo 'https://click.duga.jp/ppv/' . $videoid->productid . '/13153-36' ?>" target="_blank"
            rel="noopener">
  ...
  <div class="my-12 md:mr-8 z-0">
    <ul class="flex flex-wrap px-5 text-center font-mono text-gray-800 justify-center md:justify-start">
      ...
      <li
        class="h-9 w-1/2 md:w-40 py-1 hover:text-white border-2 border-gray-400 bg-gray-200 hover:bg-red-500 relative">
        <a href="{{ route('dmemo.memoListLatest', [ 'productid' => $videoid->productid ]) }}"
          class="pt-1 absolute top-0 left-0 w-full h-full">最新の50件</a>
      </li>
      <li
        class="h-9 w-1/2 md:w-40 py-1 hover:text-white border-2 border-gray-400 bg-gray-200 hover:bg-red-500 relative">
        <a href="{{ route('dmemo.memoListSort', [ 'productid' => $videoid->productid, 'sort' => 'oldest' ]) }}"
          class="pt-1 absolute top-0 left-0 w-full h-full">はじめから全部</a>
      </li>
      <li
        class="h-9 w-1/2 md:w-40 py-1 hover:text-white border-2 border-gray-400 bg-gray-200 hover:bg-red-500 relative">
        <a href="{{ route('dmemo.memoListSort', [ 'productid' => $videoid->productid, 'sort' => 'latest' ]) }}"
      ...
      <li
        class="h-9 w-1/2 md:w-40 py-1 hover:text-white border-2 border-gray-400 bg-gray-200 hover:bg-red-500 relative">
        <a href="<?php echo 'https://click.duga.jp/ppv/' . $videoid->productid . '/13153-38'; ?>" rel="nofollow"
          target="_blank" class="pt-1 absolute top-0 left-0 w-full h-full">DUGAで見る</a>
      </li>
    </ul>
  </div>
  ...
  <div class="flex flex-col justify-center p-1 mx-auto md:mr-8">
    ...
    <div class="border-dotted border-b border-gray-500 p-2">
      <div class="flex flex-wrap justify-between items-center">
        ...
        <div class="w-full">
          ...
          <p class="mb-3">>> No.
            <a href="{{ route('dmemo.memoListSort', [ 'sort' => 'oldest', 'productid' => $release_memo_list->d_link, '#d-' . $release_memo_list->d_no]) }}"
              class="ml-1 text-blue-500 hover:text-red-500 hover:underline">
    ...
    <div class="my-12 md:mr-8 z-0">
      <ul class="flex flex-wrap px-5 text-center font-mono text-gray-800 justify-center md:justify-start">
        ...
        <li
          class="h-9 w-1/2 md:w-40 py-1 hover:text-white border-2 border-gray-400 bg-gray-200 hover:bg-red-500 relative">
          <a href="<?php echo 'https://click.duga.jp/ppv/' . 
          $videoid->productid . '/13153-39'; ?>" rel="nofollow" target="_blank"
    ...
    @endif
    <!-- 最近のメモ動画 -->
    <div class="flex flex-wrap mt-8 mb-4 md:mr-8 border-b-4 border-gray-500 items-center justify-between">
    ...
    <div class="flex flex-wrap justify-center md:justify-start">
      ...
      <div class="m-2">
        <a href="{{ route('dvideo.show', [ 'id' => $releaselist->productid ]) }}">
          @if( $releaselist->duga->jacketimage )
          <img src="<?php echo $releaselist->duga->jacketimage ?>"
            alt="【DUGA】<?php echo $releaselist->duga->title ?>のジャケット画像" class="h-40 w-[118px] inline-block px-1 mb-4">
          @else
          <img src="<?php echo $releaselist->duga->posterimage ?>"
            alt="【DUGA】<?php echo $releaselist->duga->title ?>のメイン画像" class="h-40 w-[118px] inline-block px-1 mb-4">
          @endif
        </a>
      </div>
      @endforeach
