    ...
    <div class="container ml-1 md:ml-0 flex flex-col">
      <div class="flex flex-wrap ml-4 md:mx-2 justify-center sm:justify-start">
        ...
        <div class="w-36 mr-5 md:mr-2 mb-4">
          <a href="{{ route('flist.show', [ 'keyword' => $seriessearchlist->series ]) }}" class="p-2 border-2 text-blue-500 text-center inline-block">
            <img src="<?php echo 'https://pics.dmm.co.jp/digital/video/' .  $seriessearchlist->content_id  . '/' .  $seriessearchlist->content_id   . 'ps.jpg'; ?>" alt="[FANZA] <?php echo $seriessearchlist->title ?>のメイン画像" class="h-40">
