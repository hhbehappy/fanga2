<x-app>
  <x-slot name="title">
    【FANZA】シリーズ :『 {{ $keyword }} 』の検索結果
  </x-slot>

  <section>
    <div class="flex flex-wrap mb-5 text-white font-mono">
      <a href="{{ route('flist.series') }}" class="flex py-1 px-6 mx-2 mb-3 bg-gray-800 hover:bg-red-600 items-center">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
          <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
        </svg>
        人気シリーズ
      </a>
      <a href="{{ route('flist.series_all') }}" class="flex py-1 px-6 mx-2 mb-3 bg-gray-800 hover:bg-red-600 items-center">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
          <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
        </svg>
        全シリーズ
      </a>
      <a href="{{ route('flist.series_memo') }}" class="flex py-1 px-6 mx-2 mb-3 bg-gray-800 hover:bg-red-600 items-center">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
          <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
        </svg>
        メモの多い順
      </a>
      <a href="{{ route('flist.series_nice') }}" class="flex py-1 px-6 mx-2 mb-3 bg-gray-800 hover:bg-red-600 items-center">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
          <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
        </svg>
        気になる動画の登録数順
      ...
      <div class="h-8 ml-2">
        <form action="{{ route('flist.series_search') }}" method="GET">
    ...
    <div class="border-b-4 border-gray-500 mb-4">
      <h1 class="font-bold md:text-xl inline-block"><span class="text-red-500">【FANZA】</span>シリーズ :『 {{ $keyword }} 』の検索結果</h1>
    ...
    <div class="container ml-1 md:ml-0 flex flex-col">
      <div class="flex flex-wrap ml-4 md:mx-2 justify-center sm:justify-start">
        ...
        <div class="w-36 mr-5 md:mr-2 mb-4">
          <a href="{{ route('flist.show', [ 'sort' => 'series', 'keyword' => $seriessearchlist->series ]) }}" class="p-2 border-2 text-blue-500 text-center inline-block">
            <img src="<?php echo 'https://pics.dmm.co.jp/digital/video/' .  $seriessearchlist->content_id  . '/' .  $seriessearchlist->content_id   . 'ps.jpg'; ?>" alt="【FANZA】シリーズ「<?php echo $seriessearchlist->series ?>」" class="h-40">
