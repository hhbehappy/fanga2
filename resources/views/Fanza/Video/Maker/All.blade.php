    ...
    <div class="container ml-1 md:ml-0 flex flex-col">
      <div class="flex flex-wrap ml-4 md:mx-2 justify-center sm:justify-start">
        ...
        <div class="w-36 mr-5 md:mr-2 mb-4">
          <a href="{{ route('flist.show', [ 'sort' => 'maker', 'keyword' => $makeralllist->maker ]) }}" class="p-2 border-2 text-blue-500 text-center inline-block">
            <img src="<?php echo 'https://pics.dmm.co.jp/digital/video/' .  $makeralllist->content_id  . '/' .  $makeralllist->content_id   . 'ps.jpg'; ?>" alt="【FANZA】 <?php echo $makeralllist->title ?>のメイン画像" class="h-40">
