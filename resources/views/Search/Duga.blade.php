<x-app>
  ...
  <div class="border-b-4 border-gray-500 mb-2">
    <h1 class="font-bold text-xl inline-block"><span class="text-red-500">【DUGA】</span>『 {{ $keyword }} 』の検索一覧</h1>
    <span class="ml-5">{{ $dugas->total() }}件中 {{ $dugas->firstItem() }}〜{{ $dugas->lastItem() }}件</span>
  </div>
