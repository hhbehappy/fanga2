    ...
    <div class="flex flex-col pb-3 space-y-1">
      <p class="pb-1 pl-3 text-lg text-gray-300 bg-black">MENU</p>
        ...
        <p class="text-blue-500 pl-3">
          ...
          <a :href="route('flist.index')" class="hover:bg-red-50 hover:border-y-2 border-red-200">FANZA</a>
        </p>
        <p class="text-blue-500 pl-3">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="mb-1 w-3 h-3 inline-block text-gray-800">
            <path fill-rule="evenodd" d="M10.21 14.77a.75.75 0 01.02-1.06L14.168 10 10.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z" clip-rule="evenodd" />
          ...
          <a :href="route('dlist.index')" class="hover:bg-red-50 hover:border-y-2 border-red-200">DUGA</a>
        </p>
        <p class="text-blue-500 pl-3">
          ...
          <Link :href="route('bbs')" class="hover:bg-red-50 hover:border-y-2 border-red-200">BBS</Link>
        </p>
        <p class="text-blue-500 pl-3">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="mb-1 w-3 h-3 inline-block text-gray-800 space-y-1">
            <path fill-rule="evenodd" d="M10.21 14.77a.75.75 0 01.02-1.06L14.168 10 10.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z" clip-rule="evenodd" />
          ...
          <Link :href="route('inquiry')" class="hover:bg-red-50 hover:border-y-2 border-red-200">お問い合わせ</Link>
        </p>
        <p class="text-blue-500 pl-3">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="mb-1 w-3 h-3 inline-block text-gray-800 space-y-1">
            <path fill-rule="evenodd" d="M10.21 14.77a.75.75 0 01.02-1.06L14.168 10 10.23 6.29a.75.75 0 111.04-1.08l4.5 4.25a.75.75 0 010 1.08l-4.5 4.25a.75.75 0 01-1.06-.02z" clip-rule="evenodd" />
          ...
          <Link :href="route('logout')" method="post" as="button" class="hover:bg-red-50 hover:border-y-2 border-red-200">ログアウト</Link>
        </p>
      </div>
    </div>
  </aside>
