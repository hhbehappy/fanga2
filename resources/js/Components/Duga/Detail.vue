      ...
      <div class="container mx-auto flex flex-wrap md:flex-nowrap mb-4">
        <div class="mb-4 mx-5 md:mx-2 w-[190px] shrink-0">
          <button @click="toggleStatus" type="button" data-micromodal-trigger="modal-1">
            <img v-if="dugavideo.jacketimage"
              ...
              :alt="'【DUGA】' + dugavideo.title + 'のジャケット画像'" class="h-56 w-40">
        ...
        <div :class="{ 'hidden': detailTab !== 1, 'block': detailTab === 1 }">
          <ul class="w-full flex flex-wrap ml-6 md:ml-0">
            <li class="w-full md:w-80 md:mr-4">
                  ...
                  <tr>
                    ...
                    <td>
                      <a :href="'https://click.duga.jp/ppv/' + dugavideo.productid + '/13153-31'" target="_blank"
                        rel="noopener"
                        class="p-1 text-blue-500 rounded hover:bg-red-50 hover:border border-red-200">DUGA</a>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <!-- 作品紹介 -->
            <li class="mr-6">
              <div v-if="dugavideo.caption" class="my-6 mr-6 py-2 border-y-2 boeder-gray-200">
