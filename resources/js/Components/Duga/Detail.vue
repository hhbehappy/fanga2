    ...
    <div class="container mx-auto flex flex-wrap md:flex-nowrap mb-4">
            ...
            <tr>
              ...
              <td>
                <span v-if="dugavideo.director"
                  class="border border-gray-300 lg:border-none rounded p-1 text-blue-500 text-sm hover:border-red-200 hover:bg-red-50">
                  <a :href="route('dlist.show', { sort: 'director', keyword: dugavideo.director })">{{ dugavideo.director
                  }}</a></span>
                <span v-else class="text-2xl">----</span>
              </td>
            </tr>
            <tr>
              ...
              <td class="py-2">
                <div v-if="dugavideo.category"
                  ...
                  <a :href="route('dlist.show', { sort: 'category', keyword: dugavideo.category })">{{ dugavideo.category
                  }}</a>
                </div>
                <div v-else></div>
              </td>
      ...
      <div class="hidden lg:block w-full mr-8">
        <video controls playsinline
          :poster="'https://affsample.duga.jp/unsecure/' + dugavideo.productid + '/noauth/flvcap.jpg'" preload="metadata">
