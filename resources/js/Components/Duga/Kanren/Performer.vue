...
<template>
  <div v-if="performer && dugaperformercount !== 0">
    <div class="flex flex-wrap my-8 mx-auto border-b-4 border-gray-500 items-center justify-between">
      ...
      <a :href="route('dlist.show', { sort: 'performer', keyword: performer })" class="px-6 text-blue-500 hover:underline hover:text-red-500">
    ...
    <div class="flex overflow-x-auto hidden-scrollbar h-52 ml-4">
      <div class="flex flex-none flex-nowrap">
        <div v-for="dugaperformer in dugaperformers" :key="dugaperformer.id">
            <div class="mr-4">
