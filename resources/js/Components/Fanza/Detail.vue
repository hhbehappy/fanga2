...
export default {
  ...
  methods: {
    detailTabs: function (tabNumber) {
      this.detailTab = tabNumber
    }
  }
}
</script>
  ...
  <div v-for="videoid in videoids" :key="videoid.id">
    <section>
      ...
      <div class="container mx-auto flex flex-wrap md:flex-nowrap mb-4">
        <div class="mb-4 mx-5 md:mx-2 w-[190px] shrink-0">
          <button @click="toggleStatus" type="button" data-micromodal-trigger="modal-1">
            <img :src="'https://pics.dmm.co.jp/digital/video/' + videoid.content_id + '/' + videoid.content_id + 'ps.jpg'"
              :alt="'【FANZA】' + videoid.title + 'のメイン画像'" class="h-56 w-40">
            <span class="text-sm text-blue-600 hover:underline hover:text-red-500">イメージを拡大する</span>
          </button>
          <ul class="mt-6">
            <li class="text-center">
              <button class="w-40 mb-5 font-mono py-0.5 shadow-md rounded block leading-normal" @click="detailTabs(1)"
                :class="{ 'text-gray-600 bg-gray-200 hover:bg-gray-600 hover:text-white': detailTab !== 1, 'hidden': detailTab === 1 }">
                詳細を見る
              </button>
            </li>
            <li class="text-center">
              <button class="w-40 mb-5 font-mono py-0.5 shadow-md rounded block leading-normal" @click="detailTabs(3)"
                :class="{ 'text-gray-600 bg-gray-200 hover:bg-gray-600 hover:text-white': detailTab !== 3, 'hidden': detailTab === 3 }">
                閉じる
              </button>
            </li>
            <li class="text-center">
              <button class="w-40 mb-5 font-mono py-0.5 shadow-md rounded block leading-normal" @click="detailTabs(2)"
                :class="{ 'text-gray-600 bg-gray-200 hover:bg-gray-600 hover:text-white': detailTab !== 2, 'hidden': detailTab === 2 }">
                サンプル動画を見る
              </button>
            </li>
          </ul>
        </div>
        <div :class="{ 'hidden': detailTab !== 1, 'block': detailTab === 1 }">
          <ul class="w-full flex flex-wrap ml-6 md:ml-0">
            <li class="w-full md:w-72 md:mr-4">
                  ...
                  <tr>
                    ...
                    <td>
                      <span v-if="videoid.director"
                        class="border border-gray-300 lg:border-none rounded p-1 text-blue-500 text-sm hover:border-red-200 hover:bg-red-50">
                        <a :href="route('flist.show', { sort: 'director', keyword: videoid.director })">{{
                          videoid.director
                        }}</a></span>
                      <span v-else class="text-2xl">----</span>
                    </td>
                  ...
                  <tr>
                    ...
                    <td class="py-2">
                      ...
                      <div v-if="videoid.genre1"
                        class="inline-block border border-gray-300 lg:border-none rounded p-1 mr-2 mb-2 text-sm text-blue-500 hover:border-red-200 hover:bg-red-50">
                        <a :href="route('flist.show', { sort: 'genre', keyword: videoid.genre1 })">{{ videoid.genre1
                        }}</a>
                      </div>
                      <div v-else></div>
                      <div v-if="videoid.genre2"
                        class="inline-block border border-gray-300 lg:border-none rounded p-1 mr-2 mb-2 text-sm text-blue-500 hover:border-red-200 hover:bg-red-50">
                        <a :href="route('flist.show', { sort: 'genre', keyword: videoid.genre2 })">{{ videoid.genre2
                        }}</a>
                      </div>
                      <div v-else></div>
                      <div v-if="videoid.genre3"
                        class="inline-block border border-gray-300 lg:border-none rounded p-1 mr-2 mb-2 text-sm text-blue-500 hover:border-red-200 hover:bg-red-50">
                        <a :href="route('flist.show', { sort: 'genre', keyword: videoid.genre3 })">{{ videoid.genre3
                        }}</a>
                      </div>
                      <div v-else></div>
                      <div v-if="videoid.genre4"
                        class="inline-block border border-gray-300 lg:border-none rounded p-1 mr-2 mb-2 text-sm text-blue-500 hover:border-red-200 hover:bg-red-50">
                        <a :href="route('flist.show', { sort: 'genre', keyword: videoid.genre4 })">{{ videoid.genre4
                        }}</a>
                      </div>
                      <div v-else></div>
                      <div v-if="videoid.genre5"
                        class="inline-block border border-gray-300 lg:border-none rounded p-1 mr-2 mb-2 text-sm text-blue-500 hover:border-red-200 hover:bg-red-50">
                        <a :href="route('flist.show', { sort: 'genre', keyword: videoid.genre5 })">{{ videoid.genre5
                        }}</a>
                      </div>
                      <div v-else></div>
                      <div v-if="videoid.genre6"
                        class="inline-block border border-gray-300 lg:border-none rounded p-1 mr-2 mb-2 text-sm text-blue-500 hover:border-red-200 hover:bg-red-50">
                        <a :href="route('flist.show', { sort: 'genre', keyword: videoid.genre6 })">{{ videoid.genre6
                        }}</a>
                      </div>
                      <div v-else></div>
                      <div v-if="videoid.genre7"
                        class="inline-block border border-gray-300 lg:border-none rounded p-1 mr-2 mb-2 text-sm text-blue-500 hover:border-red-200 hover:bg-red-50">
                        <a :href="route('flist.show', { sort: 'genre', keyword: videoid.genre7 })">{{ videoid.genre7
                        }}</a>
                      </div>
                      <div v-else></div>
                      <div v-if="videoid.genre8"
                        class="inline-block border border-gray-300 lg:border-none rounded p-1 mr-2 mb-2 text-sm text-blue-500 hover:border-red-200 hover:bg-red-50">
                        <a :href="route('flist.show', { sort: 'genre', keyword: videoid.genre8 })">{{ videoid.genre8
                        }}</a>
                      </div>
                      <div v-else></div>
                      <div v-if="videoid.genre9"
                        class="inline-block border border-gray-300 lg:border-none rounded p-1 mr-2 mb-2 text-sm text-blue-500 hover:border-red-200 hover:bg-red-50">
                        <a :href="route('flist.show', { sort: 'genre', keyword: videoid.genre9 })">{{ videoid.genre9
                        }}</a>
                      </div>
                      <div v-else></div>
                    </td>
        ...
        <div :class="{ 'hidden': detailTab !== 2, 'block w-full': detailTab === 2 }">
          <h2 class="pl-2 mb-1 md:mr-10 text-xl font-bold border-b-4 border-gray-500">
            サンプル動画
          </h2>
          <div class="w-2/3 lg:w-1/2 mx-auto my-10">
            <div style="width:100%; padding-top: 75%; position:relative;">
              <iframe width="100%" height="100%" max-width="1280px" style="position: absolute; top: 0; left: 0;"
      ...
      <button @click="toggleStatus" type="button" data-micromodal-trigger="modal-1" class="w-screen md:w-full">
        <div class="flex overflow-x-scroll mx-4 my-2 pb-3 hidden-scrollbar">
          <div class="flex flex-none flex-nowrap">
            ...
            <div class="mr-5">
              <img
                :src="'https://pics.dmm.co.jp/digital/video/' + videoid.content_id + '/' + videoid.content_id + '-1.jpg'"
                :alt="'【FANZA】' + videoid.title + '1枚目の画像'" class="h-[6rem]">
            </div>
            <div class="mr-5">
              <img
                :src="'https://pics.dmm.co.jp/digital/video/' + videoid.content_id + '/' + videoid.content_id + '-2.jpg'"
                :alt="'【FANZA】' + videoid.title + '2枚目の画像'" class="h-[6rem]">
            </div>
            <div class="mr-5">
              <img
                :src="'https://pics.dmm.co.jp/digital/video/' + videoid.content_id + '/' + videoid.content_id + '-3.jpg'"
                :alt="'【FANZA】' + videoid.title + '3枚目の画像'" class="h-[6rem]">
            </div>
            <div class="mr-5">
              <img
                :src="'https://pics.dmm.co.jp/digital/video/' + videoid.content_id + '/' + videoid.content_id + '-4.jpg'"
                :alt="'【FANZA】' + videoid.title + '4枚目の画像'" class="h-[6rem]">
            </div>
            <div class="mr-5">
              <img
                :src="'https://pics.dmm.co.jp/digital/video/' + videoid.content_id + '/' + videoid.content_id + '-5.jpg'"
                :alt="'【FANZA】' + videoid.title + '5枚目の画像'" class="h-[6rem]">
            </div>
            <div class="mr-5">
              <img
                :src="'https://pics.dmm.co.jp/digital/video/' + videoid.content_id + '/' + videoid.content_id + '-6.jpg'"
                :alt="'【FANZA】' + videoid.title + '6枚目の画像'" class="h-[6rem]">
            </div>
            <div class="mr-5">
              <img
                :src="'https://pics.dmm.co.jp/digital/video/' + videoid.content_id + '/' + videoid.content_id + '-7.jpg'"
                :alt="'【FANZA】' + videoid.title + '7枚目の画像'" class="h-[6rem]">
            </div>
            <div class="mr-5">
              <img
                :src="'https://pics.dmm.co.jp/digital/video/' + videoid.content_id + '/' + videoid.content_id + '-8.jpg'"
                :alt="'【FANZA】' + videoid.title + '8枚目の画像'" class="h-[6rem]">
            </div>
            <div class="mr-5">
              <img
                :src="'https://pics.dmm.co.jp/digital/video/' + videoid.content_id + '/' + videoid.content_id + '-9.jpg'"
