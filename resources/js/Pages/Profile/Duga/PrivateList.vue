...
<template>
  <section v-if="display === 'video'">
    ...
    <MyPageMenu :memoType="memoType" :lists="videolists" :display="display" :sort="sort" :group="group" :type="type"
      :hits="hits" :color="'hover:bg-red-200'" />
    <!-- トップ -->
      ...
      <li v-for="videolist in videolists.data" :key="videolist.id">
        <div class="flex flex-nowrap lg:w-[550px] lg:mr-8 mb-6 border-2 border-gray-300">
          ...
          <Link :href="route('dvideo.show', { id: videolist.productid })"
            class="flex w-full mx-auto p-2 hover:bg-red-100 group">
        ...
        <div class="flex py-3 items-center border-dotted border-b border-gray-500">
          ...
          <div class="w-full ml-5">
            <div class="flex mb-3 items-center">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                class="w-4 h-4 text-red-300 inline-block">
                <path fill-rule="evenodd"
              ...
              <Link as="button"
              :href="route('dvideo.edit', { type: 'private', productid: memolist.productid, memoid: memolist.id }) + '#editmemo'" class="ml-auto mr-3">
            <button type="button"
              class="px-1.5 py-0.5 bg-green-600 text-white font-mono text-xs rounded shadow-md hover:bg-green-700 flex align-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            ...
            <button type="button" @click="destroyPrivateMemo(memolist.id)"
              class="px-1.5 py-0.5 bg-red-600 text-white font-semibold text-xs rounded shadow-md hover:bg-red-700 flex align-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
