    ...
    <ul class="flex list-none flex-col text-sm cursor-pointer">
      <li class="mb-2">
        <div class="flex flex-wrap">
          ...
          <div>
            <span v-if="sort === 'latest' && memoType !== 'fanza_nice'" class="mr-1">メモの新しい順</span>
            <span v-if="sort === 'latest' && memoType === 'fanza_nice'" class="mr-1">登録日の新しい順</span>
            <span v-if="sort === 'oldest' && memoType !== 'fanza_nice'" class="mr-1">メモの古い順</span>
            <span v-if="sort === 'oldest' && memoType === 'fanza_nice'" class="mr-1">登録日の古い順</span>
            /
      ...
      <div :class="{ 'hidden': openTab !== 1, 'block': openTab === 1 }">
        <ul class="flex flex-wrap">
          <li class="w-96 mb-3">
            ...
            <span v-if="sort === 'latest' && memoType !== 'fanza_nice'" class="mx-2">メモの新しい順</span>
            <span v-else-if="sort === 'latest' && memoType === 'fanza_nice'" class="mx-2">登録日の新しい順</span>
            <Link v-else-if="memoType === 'fanza_release'"
              :href="route('mypage', { page: lists.current_page, display: display, sort: 'latest', type: type, group: group, hits: hits })"
              class="mx-2 text-blue-500 hover:text-red-500 hover:underline" preserve-scroll>メモの新しい順</Link>
            <Link v-else
            ...
            <span v-if="memoType === 'fanza_nice'">登録日の新しい順</span>
            <span v-else>メモの新しい順</span>
            </Link>
            /
            <span v-if="sort === 'oldest' && memoType !== 'fanza_nice'" class="ml-2">メモの古い順</span>
            <span v-else-if="sort === 'oldest' && memoType === 'fanza_nice'" class="ml-2">登録日の古い順</span>
            <Link v-else-if="memoType === 'fanza_release'"
              :href="route('mypage', { page: lists.current_page, display: display, sort: 'oldest', type: type, group: group, hits: hits })"
              class="ml-2 text-blue-500 hover:text-red-500 hover:underline" preserve-scroll>メモの古い順</Link>
            <Link v-else
            ...
            <span v-if="memoType === 'fanza_nice'">登録日の古い順</span>
          ...
          <li v-if="display === 'video'" class="w-96 mb-3">
            ...
            <Link v-else-if="memoType === 'fanza_release'"
              :href="route('mypage', { page: lists.current_page, display: 'video', sort: sort, type: 'top', hits: hits })"
            ...
            <Link v-else-if="memoType === 'fanza_release'"
              :href="route('mypage', { page: lists.current_page, display: 'video', sort: sort, type: 'image', hits: hits })"
            ...
            <Link v-else-if="memoType === 'fanza_release'"
              :href="route('mypage', { page: lists.current_page, display: 'video', sort: sort, type: 'title', hits: hits })"
          ...
          <li v-if="display === 'memo' && group" class="w-96 mb-3">
            <span class="font-bold">表示形式</span>
            <Link v-if="memoType === 'fanza_release'"
              :href="route('mypage', { page: lists.current_page, display: 'memo', sort: sort, hits: hits })"
          ...
          <li class="w-56 mb-3">
            ...
            <Link v-else-if="memoType === 'fanza_release'"
              :href="route('mypage', { page: 1, display: display, sort: sort, type: type, group: group, hits: '20' })"
            ...
            <Link v-else-if="memoType === 'fanza_release'"
              :href="route('mypage', { page: 1, display: display, sort: sort, type: type, group: group, hits: '50' })"
            ...
            <Link v-else-if="memoType === 'fanza_release'"
              :href="route('mypage', { page: 1, display: display, sort: sort, type: type, group: group, hits: '100' })"
