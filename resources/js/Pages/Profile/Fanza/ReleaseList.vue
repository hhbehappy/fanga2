    ...
    <div class="flex flex-wrap mt-10 mb-2 mx-auto border-b-4 border-gray-500 items-center w-full">
      ...
      <p class="inline-block ml-auto mr-1 md:mr-6 font-bold">
        ...
        <span class="ml-2 font-medium">
          <Link :href="route('mypage', { display: 'memo' })" class="text-blue-500 hover:text-red-500 hover:underline"
            preserve-scroll>
          メモ
          </Link>
        </span>
      ...
      <li v-for="videolist in videolists.data" :key="videolist.id">
        <div class="flex flex-nowrap lg:w-[550px] lg:mr-8 mb-6 border-2 border-gray-300">
          ...
          <img
            ...
            :alt="'【FANZA】' + videolist.title + 'のジャケット画像'" class="h-28 w-20">
    ...
    <ul v-if="type === 'image'" class="flex flex-wrap list-none">
      <li v-for="videolist in videolists.data" :key="videolist.id" class="mr-3 mb-4">
        ...
        <img :src="'https://pics.dmm.co.jp/digital/video/' + videolist.content_id + '/' + videolist.content_id + 'ps.jpg'"
          :alt="'【FANZA】' + videolist.title + 'のジャケット画像'" class="h-44 w-32">
        </Link>
      </li>
    </ul>
    <!-- タイトル -->
        ...
        <tbody>
          <tr v-for="videolist in videolists.data" :key="videolist.id" class="border-2 border-gray-300">
            <td class="w-8 px-1 py-2 relative group">
              ...
              <Link v-else
                :href="route('fnice.store', { content_id: videolist.content_id, fanza_id: videolist.fanza_id })"
  ...
  <section v-if="display === 'memo'">
    <div class="flex flex-wrap mt-10 mb-2 mx-auto border-b-4 border-gray-500 items-center w-full">
      ...
      <p class="inline-block ml-auto mr-1 md:mr-6 font-bold">
        表示
        <span class="mx-2 font-medium">
          <Link :href="route('mypage', { display: 'video' })" class="text-blue-500 hover:text-red-500 hover:underline"
            preserve-scroll>
          動画
          </Link>
        </span>
    ...
    <ul class="flex flex-col list-none">
      <li v-for="memolist in memolists.data" :key="memolist.id">
        <div class="flex py-1 items-center border-dotted border-b border-gray-500">
          <Link v-if="group"
            :href="route('mypage', { page: memolists.current_page, display: 'memo', sort: sort, hits: hits })"
            preserve-scroll>
          ...
          <Link v-else
            :href="route('mypage', { page: 1, display: 'memo', group: memolist.content_id, sort: sort, hits: hits })"
            preserve-scroll>
          <img :src="'https://pics.dmm.co.jp/digital/video/' + memolist.content_id + '/' + memolist.content_id + 'ps.jpg'"
            :alt="'【FANZA】' + memolist.title + 'のジャケット画像'" class="w-12">
          </Link>
          <div class="w-full ml-5">
            ...
            <div class="w-full whitespace-pre-line break-all">
              ...
              <p class="flex text-xs text-gray-500 font-mono justify-end">
                No.
                <Link
                  :href="route('fmemo.memoListSort', { sort: 'oldest', content_id: memolist.content_id }) + '#f-' + memolist.id"
                  class="text-blue-500 hover:text-red-500 hover:underline">
                F-{{ memolist.id }}
                </Link>
              </p>
