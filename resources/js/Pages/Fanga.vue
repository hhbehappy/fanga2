  ...
  <Layout>
    <section>
      <div class="m-5 md:m-0 p-3 rounded border-2 border-gray-600">
        ...
        <p class="mt-3">サイト内で、はんぞ〜のメモは全て運営者が投稿しています。アダルトに費やす時間が多く取れず知識不足のうえ、忘れやすいためメモしていきたいと思います。
        </p>
        <p class="mt-3">質問・疑問等ありましたら
          <Link :href="route('inquiry')" class="text-blue-500 hover:underline hover:text-red-500">お問い合わせ</Link>
          ページよりよろしくお願い致します。
        </p>
      </div>
    </section>
