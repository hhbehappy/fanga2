    ...
    <div v-for="dugavideo in dugavideos" :key="dugavideo.id" class="">
      ...
      <div class="flex flex-col justify-center w-11/12 mx-auto p-2 mb-12">
        <div v-for="duga_release_memo in duga_release_memos" :key="duga_release_memo.id">
          <div v-if="duga_release_memo.release && props.type === 'release' ">
            <div class="border-dotted border-b border-gray-500 p-2 mb-6">
              <p class="my-3">
                ...
                <span v-else-if="duga_release_memo.nickname === 0" class="bg-blue-200 p-1 px-3 rounded-2xl text-xs">ログインユーザーのメモ</span>
          ...
          <div class="w-full">
            <form @submit.prevent="updateReleaseMemo(update_release_id.id, dugavideo.productid)">
        ...
        <div class="flex flex-wrap justify-center">
          <div class="w-full">
            <form @submit.prevent="updatePrivateMemo(update_private_id.id, dugavideo.productid)">
              <div class="flex justify-center relative">
                <div class="mb-3 w-full">
