...
<Layout>
  ...
  <div class="">
    <div class="border-b-4 border-gray-500 mb-4">
      <h1 class="font-bold md:text-2xl ml-2"><span class="text-red-500">【DUGA】</span>女優一覧 : メモの多い動画順</h1>
    </div>
      ...
      <div v-for="performerlist in performerlists" :key="performerlist.id">
        <div v-if="performerlist.performer" class="w-36 mr-1 mb-4">
          <a :href="route('dlist.show', { keyword: performerlist.performer })" class="p-2 border-2 text-blue-500 text-center inline-block">
            <img v-if="performerlist.jacketimage" :src="'https://pic.duga.jp/unsecure/' + performerlist.re_productid + '/noauth/jacket_240.jpg'" :alt="'【DUGA】' + performerlist.title" class="h-40 w-28">
            <img v-else :src="'https://pic.duga.jp/unsecure/' + performerlist.re_productid + '/noauth/180x180.jpg'" :alt="'【DUGA】' + performerlist.title + 'のメイン画像'" class="h-40 w-28">
    ...
    <div class="border-b-4 border-gray-500 my-4">
      <h2 class="font-bold md:text-2xl ml-2"><span class="text-red-500">【DUGA】</span>女優一覧 : 気になる動画の登録数順</h2>
    </div>
    <div class="flex flex-wrap ml-4 md:mx-2">
      <div v-for="performernicelist in performernicelists" :key="performernicelist.id">
        <div v-if="performernicelist.type === 'duga' && performernicelist.performer" class="w-36 mr-1 mb-4">
          <a :href="route('dlist.show', { keyword: performernicelist.performer })" class="p-2 border-2 text-blue-500 text-center inline-block">
