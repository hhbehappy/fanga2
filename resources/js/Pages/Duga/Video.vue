...
<template>
  ...
  <Layout>
    <Detail :videod="videod" :dugavideos="dugavideos" :date="date" :re_productid="re_productid" :nice="nice" :nicecount="nicecount" />
    <!-- サンプル動画 -->
    ...
    <!-- 公開メモ -->
    <ReleaseMemo :videod="videod" :duga_release_memos="duga_release_memos" :duga_release_memo_count="duga_release_memo_count" />
    <!-- フリーメモ -->
