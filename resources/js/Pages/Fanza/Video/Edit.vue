      ...
      <div class="container mx-auto flex flex-wrap md:flex-nowrap">
        ...
        <div class="mx-6 lg:ml-6 w-full md:w-3/5 lg:w-[380px] shrink-0">
          <div v-if="$page.props.auth.user" class="my-2">
            <div v-if="nice && nice.user_id === user_id"
              class="w-44 mb-4 pl-0.5 border border-gray-600 hover:border-red-500 hover:bg-red-50">
              ...
              <tr>
                ...
                <td>
                  <span v-if="videoid.actress"
                    class="border border-gray-300 lg:border-none rounded p-1 text-sm text-blue-500 hover:border-red-200 hover:bg-red-50">
      ...
      <div class="flex flex-col justify-center w-11/12 mx-auto p-2 mb-12">
        <div v-for="edit_release_memo in edit_release_memos" :key="edit_release_memo.id">
          <div v-if="edit_release_memo.release && type === 'release'">
            <div class="border-dotted border-b border-gray-500 p-2 mb-6">
              <p class="my-3">
                <span v-if="edit_release_memo.nickname === 1"
                  class="border-l-4 border-b border-blue-200 p-1 px-3 text-xs font-bold">{{ edit_release_memo.name
                  }}さんのメモ</span>
                <span v-else-if="edit_release_memo.nickname === 0"
                  class="border-l-4 border-b border-blue-200 p-1 px-3 text-xs font-bold">ログインユーザーのメモ</span>
        ...
        <div v-for="edit_private_memo in edit_private_memos" :key="edit_private_memo.id">
          <div v-if="edit_private_memo.private && type === 'private'">
            <div class="border-dotted border-b border-gray-500 p-2 mb-6">
              <p class="mb-3"><span class="border-l-4 border-b border-red-200 p-1 px-3 text-xs font-bold">{{
                edit_private_memo.name }}さんの非公開メモ</span><span class="ml-6 text-sm text-zinc-500">
