...
<BasicLayout>
  ...
  <div class="min-h-screen w-screen mt-5 md:mt-0 bg-gray-100">
    <div class="pt-8">
      <h1 class="w-4/5 max-w-3xl mx-auto mb-6 px-4 font-bold md:text-xl text-gray-800 leading-tight border-b-4 border-gray-400">BBS : 新しいスレッドを作成</h1>
    </div>
    ...
    <div class="w-4/5 max-w-3xl mx-auto">
